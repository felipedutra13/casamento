...
<html>
	...
	<body>
		...
		<div id="mural-mensagens">
			...
			<p>Palavras são carinhos doados. Obrigado por nos dar o seu carinho.</br>Iremos lembrar para sempre deste momento tão esperado.</p>
			...
			<?php 
				...
				$sql = "SELECT `nome`, `mensagem`, `data` FROM `mensagens`"; 
